...
Intelligent Tutoring System (ITS) of Programming Education is a fully automated system developed at the [Trustworthy and Secure Software Lab](https://nus-tss.github.io/) at the National University of Singapore (NUS) that aims to provide feedback and grading support for programming assignments in Computer Science (CS) courses.
