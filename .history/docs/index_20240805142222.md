...
This website provides detailed documentation of the ITS, including (1) Demo Usage, (2) API Documentation, (3) Overview of the system architecture, (4) Detailed features of the system, and (5) Illustration of the system components.
