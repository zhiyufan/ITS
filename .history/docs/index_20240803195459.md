...
<figure id="fig:its-idea", style="display: inline-block;">
  <img src="icons/its.svg" width="800", height="400">
  <figcaption style="text-align: center;">General idea of an ITS that supports students and tutors in CS-1 programming courses.</figcaption>
</figure>
